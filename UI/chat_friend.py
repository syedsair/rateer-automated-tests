...
def send_chat(driver, username, msg):
    # Send chat
    try:
        msg = fake.sentence()
        element = driver.find_element(by=By.XPATH, value='//a[@href="'+ "/messenger/chat/" + username +'"]')
        ...
        print('\n\n\
            ...
            .format(
            'https://rateer.pythonanywhere.com/messenger/chat/' + username + '/',
...
if __name__ == '__main__':
    ...
    send_chat(driver, "Jenny_Flex", "Hello from automated scripts")
